...
class UserResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Toggle::make('is_staff')->label('Staff'),
            Forms\Components\Toggle::make('is_superuser')->label('Super-utilisateur'),
        ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\IconColumn::make('is_superuser')->label('Super-utilisateur')->boolean(),
                ...
                Tables\Columns\TextColumn::make('created_at')->label('Inscription')->dateTime('d/m/Y')->sortable(),
            ])
            ->filters([
